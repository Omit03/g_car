<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"G:\xampp\htdocs\car\public/../app/index\view\index\search_newcar.html";i:1541667379;s:53:"G:\xampp\htdocs\car\app\index\view\public\header.html";i:1541579441;s:53:"G:\xampp\htdocs\car\app\index\view\public\footer.html";i:1540793843;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
//	console.log(bH-wH)
	if(wsH+50>sH){
		...
		<div class="full_wid">
			<div class="breadnav">您的位置：<a href="#">郑州新车购买市场</a>>><a href="#">新车 >></a></div>
			<div class="wrap">
				<div class="list_left">
					<div class="list_screen_cont">
						<div class="list_brand  slide_up list_item gj_clear">
							...
							<div class="screening-margin gj_clear">							
								<div class="list_car_brand list_detail_sel"><?php if(is_array($brand) || $brand instanceof \think\Collection || $brand instanceof \think\Paginator): $i = 0; $__LIST__ = $brand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/search_newcar?brand_id=<?php echo $val['id']; ?>"><?php echo $val['name']; ?></a><?php endforeach; endif; else: echo "" ;endif; ?></div>
						...
						<div class="slide_down sel_box_more all_brandshow">
							...
							<dd class='firstname'>
								...
								<a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/search_newcar?brand_id=<?php echo $vo['id']; ?>" title=''><?php echo $vo['name']; ?></a>
						...
						<div class="list_price list_item gj_clear">
							...
							<div class="screening-margin gj_clear">							
								<div class="list_detail_sel">
									...
									<a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/search_newcar?price=<?php echo $vo['id']; ?>"><?php echo $vo['name']; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
						...
						<div class="list_jibie list_item gj_clear">
							...
							<div class="screening-margin gj_clear">							
								<div class="list_detail_sel">
									...
									<a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/search_newcar?subface=<?php echo $vo['id']; ?>" class="active"><?php echo $vo['name']; ?></a>
								    <?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							            ...
							            <div data-toggle="select" class="select-menu" id="select4">
							              ...
							              <div class="menu menu6" style="display: none;" id="aselect4">
							                <dd> <a rel="nofollow" href="#" data-for="hidden_j" data-valueid="0" class="preventdefault" title="不限二手车">不限</a> </dd>
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/search_newcar?pailiang=<?php echo $val['id']; ?>" data-for='hidden_j' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
							            ...
							            <div data-toggle="select" class="select-menu" id="select7">
							              ...
							              <div class="menu menu8" style="display: none;" id="aselect7">
							                ...
							                <!--<dd> <a rel="nofollow" href="#" data-for="hidden_g" data-valueid="2" class="preventdefault" title="手动档二手车">手动</a> </dd>-->
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/search_newcar?bsx=<?php echo $val['id']; ?>" data-for='hidden_g' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
										  </div>
							            </div>
							          </li>
							          <!--<li>-->
							            <!--<div data-toggle="select" class="select-menu" id="select8">-->
							              ...
							              <!--<div class="menu menu9" style="display: none;" id="aselect8">-->
											  ...
											  <!--<dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/search_newcar?qd=<?php echo $val['id']; ?>" data-for='hidden_q' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>-->
											  <!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
							                <!--&lt;!&ndash;<dd> <a rel="nofollow" href="#" data-for="hidden_q" data-valueid="0" class="preventdefault" title="不限二手车">前驱</a> </dd>&ndash;&gt;-->
							                <!--&lt;!&ndash;<dd> <a rel="nofollow" href="#" data-for="hidden_q" data-valueid="2" class="preventdefault" title="2座二手车">前驱</a> </dd>&ndash;&gt;-->
							                <!--&lt;!&ndash;<dd> <a rel="nofollow" href="#" data-for="hidden_q" data-valueid="4" class="preventdefault" title="4座二手车">前驱</a> </dd>&ndash;&gt;-->
							              <!--</div>-->
							            <!--</div>-->
							          <!--</li>-->
							          <!--<li>-->
							            <!--<div data-toggle="select" class="select-menu" id="select12">-->
							              ...
							              <!--<div class="menu menu12" style="display: none;" id="aselect12">-->
											  ...
											  <!--<dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/search_newcar?car_body=<?php echo $val['id']; ?>" data-for='hidden_x' data-valueid='' class='preventdefault' title='不限二手车'><?php echo $val['name']; ?></a>-->
							                <!--&lt;!&ndash;<dd> <a rel="nofollow" href="#" data-for="hidden_x" data-valueid="0" class="preventdefault" title="不限二手车">前驱</a> </dd>&ndash;&gt;-->
							                <!--&lt;!&ndash;<dd> <a rel="nofollow" href="#" data-for="hidden_x" data-valueid="2" class="preventdefault" title="2座二手车">前驱</a> </dd>&ndash;&gt;-->
							                <!--&lt;!&ndash;<dd> <a rel="nofollow" href="#" data-for="hidden_x" data-valueid="4" class="preventdefault" title="4座二手车">前驱</a> </dd>&ndash;&gt;-->
											  <!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
							              <!--</div>-->
							            <!--</div>-->
							          <!--</li>-->
							            ...
							            <!--<div data-toggle="select" class="select-menu" id="select6">-->
							              ...
							              <!--<div class="menu menu7 radius menuCar07" style="display: none;" id="aselect6">-->
							                <!--<dd> <a rel="nofollow" href="" data-for="hidden_c" data-valueid="0" class="preventdefault c0" title="不限二手车">不限</a> </dd>-->
											  ...
											  <!--<dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/search_newcar?ys=<?php echo $val['id']; ?>" data-for='hidden_c' data-valueid='' class='preventdefault c15' title=''><?php echo $val['name']; ?></a> </dd>-->
							                <!--&lt;!&ndash;<dd> <a rel="nofollow" href="#" data-for="hidden_c" data-valueid="1" class="preventdefault c1" title="黑色二手车">黑色</a> </dd>&ndash;&gt;-->
											  <!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
							              <!--</div>-->
							            <!--</div>-->
							          <!--</li>-->
							            ...
							            <div data-toggle="select" class="select-menu" id="select10">
							              ...
							              <div class="menu menu12" style="display: none;" id="aselect10">
							                ...
							                <dd> <a rel="nofollow" href="" data-for="hidden_d" data-valueid="0" class="preventdefault" title="不限二手车">不限</a> </dd>
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/search_newcar?ny=<?php echo $val['id']; ?>" data-for='hidden_w' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
					...
					<div class="marbt30 carList_info">
						 <ul class="list">
                           ...
                           <?php if(is_array($ss) || $ss instanceof \think\Collection || $ss instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($ss) ? array_slice($ss,1,8, true) : $ss->slice(1,8, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
							...
							<li class="items5">
								...
								<a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/detail/<?php echo $val['id']; ?>" class="car_desc">
									...
									<p><span class="car_price"><b><?php echo $val['can_price']; ?></b>万</span><span class="car_sui">新车含税<?php echo $val['price']; ?>万</span></p>
									<p><span>首付<?php echo $val['pay10_s2']; ?></span> <span class="padlt20">月供<?php echo $val['pay10_y2']; ?></span> </p>
