<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"G:\xampp\htdocs\car\public/../app/index\view\zerocar\zerocardetails.html";i:1541496516;s:53:"G:\xampp\htdocs\car\app\index\view\public\header.html";i:1541494130;s:53:"G:\xampp\htdocs\car\app\index\view\public\footer.html";i:1540793843;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
			...
			<div class="wrap">
				<div class="oh new_details">
		        	...
		        	<div class="detail_desc new_details">
		        		...
		        		<div class="car_results">
		        			...
		        			<ul class="btn_box">
			        			<a href="<?php echo url('user/collect_car'); ?>?brand_id=<?php echo $carinfo['brand_id']; ?>&sys_id=<?php echo $carinfo['sys_id']; ?>&type=3&cartype_id=<?php echo $carinfo['cartype_id']; ?>&cheid=<?php echo $carinfo['id']; ?>&name=<?php echo $carinfo['car_name']; ?>&img_url=<?php echo $carinfo['img_512']['0']; ?>&shoufu=<?php echo $carinfo['pay0_s2']; ?>&ygong=<?php echo $carinfo['pay0_y2']; ?>&price=<?php echo $carinfo['price']; ?>"><li><img src="/static/img/collect.png" alt="" /><p>收藏</p></li></a>
				...
				<div class="car_list">
					<ul class="list">
						...
						<li class="items5">
							<a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/detai/<?php echo $vol['id']; ?>" class="car_img flex_center"><img src="<?php echo $vol['img_url']; ?>" alt="" /></a>
							<a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/detai/<?php echo $vol['id']; ?>" class="car_desc">
