<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"G:\xampp\htdocs\car\public/../app/index\view\index\change.html";i:1539654336;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
			...
			<div class="wrap">
				...
				<div class="car_list">
					<ul class="list">
						...
						<li class="items">
							<a href="" class="car_img flex_center" title=""><img src="" alt="" title=""/></a>
							<a href="" class="car_desc" title="">
								<h3>奔驰A4L 2017款 plus 40 TFSI 进取型</h3>
								<p><span class="car_price"><b>2066</b>万</span><span class="car_sui">新车含税13.86万</span></p>
								<p><span>2015年8月10日上牌</span> <span class="padlt20">4万公里</span> </p>
								<div class="che_ordered">立即预约</div>
