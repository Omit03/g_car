<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"G:\xampp\htdocs\car\public/../app/index\view\newcar\index.html";i:1541379562;s:53:"G:\xampp\htdocs\car\app\index\view\public\header.html";i:1541484408;s:53:"G:\xampp\htdocs\car\app\index\view\public\footer.html";i:1540793843;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8"/>
   		...
   		<div class="classify p_r">
   			 ...
   			 <div class="type_new fleft oh">
					...
					<?php if(is_array($subface) || $subface instanceof \think\Collection || $subface instanceof \think\Paginator): $i = 0; $__LIST__ = $subface;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
   			 		<li><a href="<?php echo url('index/search_newcar'); ?>?subface=<?php echo $val['id']; ?>"><img src="/static/img/<?php echo $val['img']; ?>" alt=""  width="100" height="100"/><p><?php echo $val['name']; ?></p></a></li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
   			 	</ul>
   			 </div>			 
	   ...
	   <div class="gj_clear">
		    ...
		    <div class="first_public">
		    	<ul class="md50">
		    		...
		    		<li>
						<a href="<?php echo url('newcar/newcardetails'); ?>?brand_id=<?php echo $val['brand_id']; ?>&sys_id=<?php echo $val['sys_id']; ?>&cartype_id=<?php echo $val['cartype_id']; ?>&id=<?php echo $val['id']; ?>">
