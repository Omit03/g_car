<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"G:\xampp\htdocs\car\public/../app/index\view\user\forgetpwd.html";i:1541148267;s:53:"G:\xampp\htdocs\car\app\index\view\public\header.html";i:1540866327;s:53:"G:\xampp\htdocs\car\app\index\view\public\footer.html";i:1540793843;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
//	console.log(bH-wH)
	if(wsH+50>sH){
		...
		$(".header").removeClass('fixedTop')
			...
			<div class="login_bg">
				<div class="login_tab">
					<form class="login_phone"  action="<?php echo url('user/find_pwd'); ?>" method="post">
					<div class="login_sure">
						...
						<div class="login_phone">
							...
							<input class="regist_btn free_regist" type="submit" value="找回密码" />
						</div>
