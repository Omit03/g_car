<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"G:\xampp\htdocs\car\public/../app/index\view\user\car_login.html";i:1541577534;s:53:"G:\xampp\htdocs\car\app\index\view\public\header.html";i:1541579441;s:53:"G:\xampp\htdocs\car\app\index\view\public\footer.html";i:1540793843;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
				...
				<div class="login_tab" >
					<div class="login_sure">
						...
						<form class="login_phone" id="conbd01" action="<?php echo url('user/login'); ?>" method="post">
								...
								<p class="ptp15"><input type="checkbox" name="zidong" value="1" />自动登录 <span class="forgetPwd"><a href="<?php echo url('user/forgetpwd'); ?>" class="color9">忘记密码</a></span></p>
						...
						<form class="login_phone" id="conbd02" style="display: none;" action="<?php echo url('user/login_sms'); ?>" method="post" >
							...
							<p class="ptp15"><input type="checkbox" name="zidong" id="" value="1" />自动登录 <span class="forgetPwd"><a href="<?php echo url('user/forgetpwd'); ?>" class="color9">忘记密码</a></span></p>
							<input class="login_btn btn_login_n" type="submit" value="立即登录" />
							<a href="<?php echo url('user/register'); ?>"> <p class="regist_btn" style="margin:0px">免费注册</p></a>
						</form>
					</div>
