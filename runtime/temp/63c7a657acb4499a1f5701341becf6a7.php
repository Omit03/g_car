			...
			<div class="wrap">
				...
				<div id="old_car_panel_1" class="recom_new_con" style="display: none;">
					<ul class="recom_tit_img">
						...
						<li>
							<a href="<?php echo url('index/details'); ?>?cheid=<?php echo $val['pu_id']; ?>&price=<?php echo $val['price']; ?>&mileage=<?php echo $val['car_mileage']; ?>&name=<?php echo $val['name_li']; ?>&img=<?php echo $val['img_url']; ?>&time=<?php echo $val['car_cardtime']; ?>" class="flex_around">
									<span class="car_img"><img class='lazy-load' alt="" titlt='' src='<?php echo $val['img_url']; ?>'/>
								</span>
