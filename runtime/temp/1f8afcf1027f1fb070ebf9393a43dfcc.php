<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"G:\xampp\htdocs\car\public/../app/index\view\newcar\newcardetails.html";i:1541380532;s:53:"G:\xampp\htdocs\car\app\index\view\public\header.html";i:1541484408;s:53:"G:\xampp\htdocs\car\app\index\view\public\footer.html";i:1540793843;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<div class="site_nav_bd">
		...
		<div class="fright">
			<ul class="site_nav_menu">
				...
				<?php if(!(empty(\think\Session::get('phone')) || ((\think\Session::get('phone') instanceof \think\Collection || \think\Session::get('phone') instanceof \think\Paginator ) && \think\Session::get('phone')->isEmpty()))): ?><li><a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/per_his"><img src="/static/img/wangahn.png" alt="" />会员中心</a></li><?php endif; if(!(empty(\think\Session::get('phone')) || ((\think\Session::get('phone') instanceof \think\Collection || \think\Session::get('phone') instanceof \think\Paginator ) && \think\Session::get('phone')->isEmpty()))): ?><li><a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/logout"><img src="/static/img/wangahn.png" alt="" />安全退出</a></li><?php endif; ?>
			</ul>
		</div>
	</div>
</div>
...
//	console.log(bH-wH)
	if(wsH+50>sH){
		...
		<div class="breadnav">你的位置:<a href="">新车</a>>><a href=""> <?php echo $newcar_info['city']; ?></a> </div>
		<div class="full_wid">		
			<div class="wrap">
				<div class="oh new_details">
					<div class="detail_pic">
						...
						<div id="picBox" class="picBox">
							<ul class="cf">
								<?php if(is_array($newcar_info['img_512']) || $newcar_info['img_512'] instanceof \think\Collection || $newcar_info['img_512'] instanceof \think\Paginator): $i = 0; $__LIST__ = $newcar_info['img_512'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?>
		        	...
		        	<div class="detail_desc new_details">
		        		<div class="detail_info">
		        			<h1><?php echo $newcar_info['name']; ?></h1>
		        			<div class=""><span class=" color6">厂商指导价：<?php echo $newcar_info['price']; ?>万 </span></div>
		        			<div class="call_shop">1到2成首付秒爆款 详情咨询商家：<b class=""><?php echo $telephone; ?></b></div>
		        		</div>
		        			<h2 class="project">分期方案</h2>
				           	...
				           	<div class="first_result">
				           		<div class="first_s">
				           			<ul class="">
					           			<li><div><p>首
					           				付</p><h2><?php echo $newcar_info['pay10_s2']; ?>万</h2></div></li>
					           			<li><div><p>月供</p><h2><?php echo $newcar_info['pay10_y2']; ?>元</h2></div></li>
					           			<li><div><p>期数</p><h2><?php echo $newcar_info['pay10_n2']; ?>期</h2></div></li>
					           		</ul>
					           	
					           	</div>
					           	<div class="first_s">
					           		<ul class="">
					           			<li><div><p>首付</p><h2><?php echo $newcar_info['pay20_s2']; ?>万</h2></div></li>
					           			<li><div><p>月供</p><h2><?php echo $newcar_info['pay20_y2']; ?>元</h2></div></li>
					           			<li><div><p>期数1</p><h2><?php echo $newcar_info['pay20_n2']; ?>期</h2></div></li>
					           		</ul>
					           	
					           	</div>
					           	<div class="first_s">
					           		<ul class="">
					           			<li><div><p>首付</p><h2><?php echo $newcar_info['pay30_s2']; ?>万</h2></div></li>
					           			<li><div><p>月供</p><h2><?php echo $newcar_info['pay30_y2']; ?>元</h2></div></li>
					           			<li><div><p>期数</p><h2><?php echo $newcar_info['pay30_n2']; ?>期</h2></div></li>
					           		</ul>
	        	...
	        	<ul class="detail_information">
	        		<li>
						...
						<?php if(!(empty($carparam['info']) || (($carparam['info'] instanceof \think\Collection || $carparam['info'] instanceof \think\Paginator ) && $carparam['info']->isEmpty()))): ?>
	        			<div>
				...
				<?php if(!(empty($carparam['info']) || (($carparam['info'] instanceof \think\Collection || $carparam['info'] instanceof \think\Paginator ) && $carparam['info']->isEmpty()))): ?><p class="more_config">查看更多配置</p><?php endif; ?>
			    ...
			    <div class="shop_4s">
			    	<ul class="list_shop">
						<?php if(is_array($shop) || $shop instanceof \think\Collection || $shop instanceof \think\Paginator): $i = 0; $__LIST__ = $shop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?>
			    		<li>
			    			<div class="shop_name"><p class="fleft"><span class="signal_4s">4S店</span> <?php echo $vol['shop_name']; ?></p><span class="fright">售郑州</span></div>
			    			...
			    			<p><img src="/static/img/dianhua1.png" alt="" /><?php echo $vol['shop_phone']; ?></p>
					    	<p><img src="/static/img/dingwei.png" alt="" /><?php echo $vol['shop_address']; ?>    <a href="" class="coloryel">[到这里]</a></p>
				...
				<div class="car_list">
					<ul class="list">
						...
						<li class="items5">
							<a href="<?php echo url('newcar/newcardetails'); ?>?brand_id=<?php echo $vol['brand_id']; ?>&sys_id=<?php echo $vol['sys_id']; ?>&cartype_id=<?php echo $vol['cartype_id']; ?>&id=<?php echo $vol['id']; ?>" class="car_img flex_center"><img src="<?php echo $vol['img_url']; ?>" alt="" /></a>
							<a href="" class="car_desc">
								<h3><?php echo $vol['name']; ?></h3>
								<p><span class="car_price">新车含税<b><?php echo $vol['can_price']; ?></b>万</span><span class="car_sui">指导价<?php echo $vol['price']; ?>万</span></p>
								<!--<p><span>2015年8月10日上牌</span> <span class="padlt20"><?php echo $vol['img_url']; ?>4万公里</span> </p>-->
  ...
  <div class="photoList">
  		...
  		<div class="silde_info">
  			<h2><?php echo $newcar_info['name']; ?></h2>
  			<!--<p class="info_car">2016年-11月 | 1.6万公里 | 国4(国5) | 郑州</p>-->
  			<div class="tag flex_center"><span>准新车</span><span>店铺认证</span></div>
  			<div class="info_price"><b>￥<?php echo $newcar_info['can_price']; ?>万&nbsp;</b>指导价：<?php echo $newcar_info['price']; ?>万</div>
  			<div class="car_form">
  ...
  <!--更多车辆信息配置-->
  	<div class="carConfig">
  		...
  		<h3><?php echo $newcar_info['name']; ?></h3>
  		<div class="configBox">
