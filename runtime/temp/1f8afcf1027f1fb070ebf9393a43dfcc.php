<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"G:\xampp\htdocs\car\public/../app/index\view\newcar\newcardetails.html";i:1539654336;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>
		...
		<div class="breadnav">你的位置:<a href="">新车</a>>><a href="">郑州奥迪 L</a>＞<a href="">奥迪A4</a> </div>
		<div class="full_wid">		
			<div class="wrap">
				<div class="oh new_details">
					<div class="detail_pic">
						...
						<div id="listBox" class="listBox">
							<ul class="cf">
								...
								<li class=""><i class="arr2"></i><img src="/static/img/83293792.jpg" alt=""></li>
								<li class=""><i class="arr2"></i><img src="/static/img/83293792.jpg" alt=""></li>
								<li class=""><i class="arr2"></i><img src="/static/img/83293792.jpg" alt=""></li>
								<li class=""><i class="arr2"></i><img src="/static/img/83293792.jpg" alt=""></li>							
							</ul>
		        	...
		        	<div class="detail_desc new_details">
		        		<div class="detail_info">
		        			<h1>威虎 2018款 2.8T柴油国V两驱豪华型大双CA4D28C5-1B</h1>
		        			<div class=""><span class=" color6">厂商指导价：33.80万 </span></div>
		        			<div class="call_shop">1到2成首付秒爆款 详情咨询商家：<b class="">17737131319</b></div>
		        		</div>
		        			<h2 class="project">分期方案</h2>
				           	...
				           	<div class="first_result">
				           		<div class="first_s">
				           			<ul class="">
					           			<li><div><p>首
					           				付</p><h2>5.5万</h2></div></li>
					           			<li><div><p>月供</p><h2>5555元</h2></div></li>
					           			<li><div><p>期数</p><h2>12期</h2></div></li>
					           		</ul>
