<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"G:\xampp\htdocs\car\public/../app/index\view\shop\add_comment.html";i:1541234762;s:53:"G:\xampp\htdocs\car\app\index\view\public\header.html";i:1540866327;s:53:"G:\xampp\htdocs\car\app\index\view\public\footer.html";i:1540793843;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8"/>
...
<div class="full_wid">
	<div class="wrap">
		...
		<form action="<?php echo url('shop/remark'); ?>" enctype="multipart/form-data"  method="post">
		...
		<div class="add_com">
			...
			<div class="score_cont gj_clear">
				...
				<div class="tag_list">
					...
					<?php if(is_array($lables) || $lables instanceof \think\Collection || $lables instanceof \think\Paginator): $i = 0; $__LIST__ = $lables;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>

					<input type="text" name="lable" >
					<span tag_check='0'  tag_value="<?php echo $val['id']; ?>"><?php echo $val['lable']; ?></span>
					<!--<input type="text" name="lable[]" value="">-->
	        ...
	        <div class="textareabox p_r">
	        	<textarea class="form_textarea" data-length="500" id="information" name="content"  data-toggle="textarea"
	        ...
	        <ul class="buy_step oh">
	        	<li><input type="checkbox" class="checked" name="have_ls"/><b></b><span>未联系</span></li>
	        	<li><input type="checkbox" /><b></b><span>未购车</span></li>
	        	<li><input type="checkbox" /><b></b><span>未到店</span></li>
	        </ul>
			<div class="add_btn"><input type="submit" value="发表评论"/></div>
			<p>
