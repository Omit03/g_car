			...
			<div class="wrap">
	        	...
	        	<ul class="detail_information">
	        		<li>
	        			<h3>基本配置</h3>
	        			<div>
							<?php if(!(empty($carparam) || (($carparam instanceof \think\Collection || $carparam instanceof \think\Paginator ) && $carparam->isEmpty()))): ?>
  			...
  			<div class="configCont">
				<?php if(!(empty($carparam) || (($carparam instanceof \think\Collection || $carparam instanceof \think\Paginator ) && $carparam->isEmpty()))): ?>
  				...
  				<div class="config_f con2">
  					...
  					<ul class="">
						<?php if(!(empty($carparam) || (($carparam instanceof \think\Collection || $carparam instanceof \think\Paginator ) && $carparam->isEmpty()))): if(is_array($carparam['nbbase']) || $carparam['nbbase'] instanceof \think\Collection || $carparam['nbbase'] instanceof \think\Paginator): $i = 0; $__LIST__ = $carparam['nbbase'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?>
  						<li>
							<p><?php echo $vol['name']; ?></p>
							<span><?php echo $vol['content']; ?></span>
  						</li>
  				...
  				<div class="config_f con3">
  					...
  					<ul class="">
						<?php if(!(empty($carparam) || (($carparam instanceof \think\Collection || $carparam instanceof \think\Paginator ) && $carparam->isEmpty()))): if(is_array($carparam['wbfdpzhi']) || $carparam['wbfdpzhi'] instanceof \think\Collection || $carparam['wbfdpzhi'] instanceof \think\Paginator): $i = 0; $__LIST__ = $carparam['wbfdpzhi'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?>
  						<li>
							<p><?php echo $vol['name']; ?></p>
							<span><?php echo $vol['content']; ?></span>
  						</li>
