<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"G:\xampp\htdocs\car\public/../app/index\view\index\details.html";i:1540779138;s:53:"G:\xampp\htdocs\car\app\index\view\public\header.html";i:1540775304;s:53:"G:\xampp\htdocs\car\app\index\view\public\footer.html";i:1540774757;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
		...
		<div class="full_wid">
			...
			<div class="wrap">
				...
				<div class="car_list">
					<ul class="list">
						<a href="">
						<?php if(is_array($sys_cars) || $sys_cars instanceof \think\Collection || $sys_cars instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($sys_cars) ? array_slice($sys_cars,1,8, true) : $sys_cars->slice(1,8, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
						<li class="items5">
