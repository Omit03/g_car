<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"G:\xampp\htdocs\car\public/../app/index\view\twocar\index.html";i:1541495853;s:53:"G:\xampp\htdocs\car\app\index\view\public\header.html";i:1541500432;s:53:"G:\xampp\htdocs\car\app\index\view\public\footer.html";i:1540793843;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
					...
					<div class="list_screen_cont">
						<div class="list_brand  slide_up list_item gj_clear">
							...
							<div class="screening-margin gj_clear">							
								<div class="list_car_brand list_detail_sel"><?php if(is_array($brand) || $brand instanceof \think\Collection || $brand instanceof \think\Paginator): $i = 0; $__LIST__ = $brand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><a href="<?php echo url('index/lots_cars'); ?>?brand_id=<?php echo $val['id']; ?>&page=1&sort=1"><?php echo $val['name']; ?></a><?php endforeach; endif; else: echo "" ;endif; ?></div>
						...
						<div class="slide_down sel_box_more all_brandshow">
							...
							<dd class='firstname'>
								...
								<a href="<?php echo url('index/lots_cars'); ?>?brand_id=<?php echo $vo['id']; ?>&page=1&sort=1" title=''><?php echo $vo['name']; ?></a>
						...
						<div class="list_price list_item gj_clear">
							...
							<div class="screening-margin gj_clear">							
								<div class="list_detail_sel">
									...
									<a href="<?php echo url('index/lots_cars'); ?>?price_range=<?php echo $vo['id']; ?>&page=1&sort=1"><?php echo $vo['name']; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
						...
						<div class="list_jibie list_item gj_clear">
							...
							<div class="screening-margin gj_clear">							
								<div class="list_detail_sel">
									...
									<a href="<?php echo url('index/lots_cars'); ?>?subface=<?php echo $vo['id']; ?>&page=1&sort=1" class="active"><?php echo $vo['name']; ?></a>
								    <?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							            ...
							            <div data-toggle="select" name="k" class="select-menu" id="select3">
							              ...
							              <dl class="menu menu5" style="display: none;" id="aselect3">
							                ...
							                <!--<dd> <a rel="nofollow" href="#" data-for="hidden_k" data-valueid="0-1" class="preventdefault" title="1万公里以内二手车">1万公里以内</a> </dd>-->
											  ...
											  <dd> <a rel='nofollow' href="<?php echo url('index/lots_cars'); ?>?car_mileage=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_k' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a></dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
										  </dl>
							            </div>
							          </li>
							            ...
							            <div data-toggle="select" class="select-menu" id="select4">
							              ...
							              <div class="menu menu6" style="display: none;" id="aselect4">
							                <dd> <a rel="nofollow" href="#" data-for="hidden_j" data-valueid="0" class="preventdefault" title="不限二手车">不限</a> </dd>
											  ...
											  <dd> <a rel='nofollow' href="<?php echo url('index/lots_cars'); ?>?output=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_j' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
							            ...
							            <div data-toggle="select" class="select-menu" id="select7">
							              ...
							              <div class="menu menu8" style="display: none;" id="aselect7">
							                ...
							                <!--<dd> <a rel="nofollow" href="#" data-for="hidden_g" data-valueid="2" class="preventdefault" title="手动档二手车">手动</a> </dd>-->
											  ...
											  <dd> <a rel='nofollow' href="<?php echo url('index/lots_cars'); ?>?gearbox=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_g' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
										  </div>
							            </div>
							          </li>
							            ...
							            <div data-toggle="select" name="r" class="select-menu" id="select5">
							              ...
							              <dl class="menu menu4" style="display: none;" id="aselect5">
							                ...
							                <!--<dd> <a rel="nofollow" href="#" data-for="hidden_h" data-valueid="5" class="preventdefault" title="国五二手车">国五</a> </dd>-->
											  ...
											  <dd> <a rel='nofollow' href="<?php echo url('index/lots_cars'); ?>?blowdown=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_h' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
							              </dl>
							            </div>
							          </li>
							          <li>
							            <div data-toggle="select" class="select-menu" id="select8">
							              ...
							              <div class="menu menu9" style="display: none;" id="aselect8">
											  ...
											  <dd> <a rel='nofollow' href="<?php echo url('index/lots_cars'); ?>?car_drive=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_q' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
							          ...
							          <li>
							            <div data-toggle="select" class="select-menu" id="select12">
							              ...
							              <div class="menu menu12" style="display: none;" id="aselect12">
											  ...
											  <dd> <a rel='nofollow' href="<?php echo url('index/lots_cars'); ?>?car_body=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_x' data-valueid='' class='preventdefault' title='不限二手车'><?php echo $val['name']; ?></a>
