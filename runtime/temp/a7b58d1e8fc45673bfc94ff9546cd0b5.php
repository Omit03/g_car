<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"G:\xampp\htdocs\car\public/../app/index\view\twocar\index.html";i:1541645992;s:53:"G:\xampp\htdocs\car\app\index\view\public\header.html";i:1541579441;s:53:"G:\xampp\htdocs\car\app\index\view\public\footer.html";i:1540793843;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
					...
					<div class="list_screen_cont">
						<div class="list_brand  slide_up list_item gj_clear">
							...
							<div class="screening-margin gj_clear">							
								<div class="list_car_brand list_detail_sel"><?php if(is_array($brand) || $brand instanceof \think\Collection || $brand instanceof \think\Paginator): $i = 0; $__LIST__ = $brand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?brand_id=<?php echo $val['id']; ?>&page=1&sort=1"><?php echo $val['name']; ?></a><?php endforeach; endif; else: echo "" ;endif; ?></div>
						...
						<div class="list_price list_item gj_clear">
							...
							<div class="screening-margin gj_clear">							
								<div class="list_detail_sel">
									...
									<a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?price_range=<?php echo $vo['id']; ?>&page=1&sort=1"><?php echo $vo['name']; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
						...
						<div class="list_jibie list_item gj_clear">
							...
							<div class="screening-margin gj_clear">							
								<div class="list_detail_sel">
									...
									<a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?subface=<?php echo $vo['id']; ?>&page=1&sort=1" class="active"><?php echo $vo['name']; ?></a>
								    <?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							            ...
							            <div data-toggle="select" name="r" class="select-menu"  id="select2">
							              ...
							              <dl class="menu menu4" style="display: none;" id="aselect2">
							                <dd> <a rel="nofollow" href="#" data-for="hidden_r" data-valueid="0" class="preventdefault" title="不限二手车">不限</a> </dd>
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?age=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_r' data-valueid='' class='preventdefault' title=''><?php echo $val['cheling']; ?></a> </dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
							              </dl>
							            </div>
							          </li>
							            ...
							            <div data-toggle="select" name="k" class="select-menu" id="select3">
							              ...
							              <dl class="menu menu5" style="display: none;" id="aselect3">
							                ...
							                <!--<dd> <a rel="nofollow" href="#" data-for="hidden_k" data-valueid="0-1" class="preventdefault" title="1万公里以内二手车">1万公里以内</a> </dd>-->
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?car_mileage=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_k' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a></dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
										  </dl>
							            </div>
							          </li>
							            ...
							            <div data-toggle="select" class="select-menu" id="select4">
							              ...
							              <div class="menu menu6" style="display: none;" id="aselect4">
							                <dd> <a rel="nofollow" href="#" data-for="hidden_j" data-valueid="0" class="preventdefault" title="不限二手车">不限</a> </dd>
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?output=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_j' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
							            ...
							            <div data-toggle="select" class="select-menu" id="select7">
							              ...
							              <div class="menu menu8" style="display: none;" id="aselect7">
							                ...
							                <!--<dd> <a rel="nofollow" href="#" data-for="hidden_g" data-valueid="2" class="preventdefault" title="手动档二手车">手动</a> </dd>-->
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?gearbox=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_g' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
										  </div>
							            </div>
							          </li>
							            ...
							            <div data-toggle="select" name="r" class="select-menu" id="select5">
							              ...
							              <dl class="menu menu4" style="display: none;" id="aselect5">
							                ...
							                <!--<dd> <a rel="nofollow" href="#" data-for="hidden_h" data-valueid="5" class="preventdefault" title="国五二手车">国五</a> </dd>-->
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?blowdown=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_h' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
							              </dl>
							            </div>
							          </li>
							          <li>
							            <div data-toggle="select" class="select-menu" id="select8">
							              ...
							              <div class="menu menu9" style="display: none;" id="aselect8">
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?car_drive=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_q' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
											  <?php endforeach; endif; else: echo "" ;endif; ?>
							          ...
							          <li>
							            <div data-toggle="select" class="select-menu" id="select12">
							              ...
							              <div class="menu menu12" style="display: none;" id="aselect12">
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?car_body=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_x' data-valueid='' class='preventdefault' title='不限二手车'><?php echo $val['name']; ?></a>
							            ...
							            <div data-toggle="select" class="select-menu" id="select6">
							              ...
							              <div class="menu menu7 radius menuCar07" style="display: none;" id="aselect6">
							                <dd> <a rel="nofollow" href="" data-for="hidden_c" data-valueid="0" class="preventdefault c0" title="不限二手车">不限</a> </dd>
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?color=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_c' data-valueid='' class='preventdefault c15' title=''><?php echo $val['name']; ?></a> </dd>
							            ...
							            <div data-toggle="select" class="select-menu" id="select10">
							              ...
							              <div class="menu menu12" style="display: none;" id="aselect10">
							                ...
							                <dd> <a rel="nofollow" href="" data-for="hidden_d" data-valueid="0" class="preventdefault" title="不限二手车">不限</a> </dd>
											  ...
											  <dd> <a rel='nofollow' href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/lots_cars?fuel=<?php echo $val['id']; ?>&page=1&sort=1" data-for='hidden_w' data-valueid='' class='preventdefault' title=''><?php echo $val['name']; ?></a> </dd>
						 ...
						 <ul class="list">
                           ...
                           <?php if(is_array($er_car) || $er_car instanceof \think\Collection || $er_car instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($er_car) ? array_slice($er_car,1,8, true) : $er_car->slice(1,8, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							...
							<li class="items5">
								...
								<a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/details/<?php echo $vo['pu_id']; ?>" class="car_img flex_center"><img src="<?php echo $vo['img_url']; ?>" alt="" /></a>
								<a href="<?php echo $domain; ?>/<?php echo \think\Session::get('cityurl'); ?>/details/<?php echo $vo['pu_id']; ?>" class="car_desc">
