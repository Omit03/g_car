<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"G:\xampp\htdocs\car\public/../app/index\view\shop\shop_list.html";i:1541381991;s:53:"G:\xampp\htdocs\car\app\index\view\public\header.html";i:1540866327;s:53:"G:\xampp\htdocs\car\app\index\view\public\footer.html";i:1540793843;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
				...
				<div class="listImg">
					...
					<div class="gj_clear" >
						<ul class="store_list gj_clear">
							...
							<li class="items"><a href="<?php echo url('index/details'); ?>?cheid=<?php echo $val['pu_id']; ?>" class="car_img flex_center"><img src="<?php echo $val['img_url']; ?>" alt="" /><a href="" class="car_desc"><h3><?php echo $val['name']; ?></h3><div class="fleft"><p>里程：<?php echo $val['car_mileage']; ?>公里</p><p>年份：<?php echo $val['car_cardtime']; ?></p></div><div class="fright car_money">¥<b><?php echo $val['price']; ?></b>万</div>	</a></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
						<div class="page">
